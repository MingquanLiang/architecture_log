    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cpu_type', models.CharField(default='CPU 1.0', max_length=32, verbose_name='CPU Type', choices=[('CPU 1.0', 'CPU 1.0'), ('CPU 1.1', 'CPU 1.1')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, verbose_name='ID', serialize=False, primary_key=True)),
                ('machine_side', models.CharField(default='server_side', max_length=32, verbose_name='Server/Client', choices=[('server_side', 'As a Server'), ('client_side', 'As a Client')])),
                ('machine_name', models.CharField(default='Habonaro', max_length=32, verbose_name='Machine Name', choices=[('Habonaro', 'Habonaro'), ('Palmetto', 'Palmetto'), ('S812L', 'S812L'), ('S822L', 'S822L'), ('X86_E5', 'X86 E5 Series')])),
                ('architecture_type', models.CharField(default='powerpc', max_length=32, verbose_name='Architecture', choices=[('x86', 'x86'), ('powerpc', 'powerpc'), ('arm64', 'arm64'), ('mips', 'mips')])),
                ('byte_order', models.CharField(default='big_endian', max_length=32, verbose_name='Litter or Big endian', choices=[('litter_endian', 'Litter Endian'), ('big_endian', 'Big Endian')])),
                ...
                ('os_type', models.CharField(default='Ubuntu 14.04.2', max_length=64, verbose_name='Operation System', choices=[('Ubuntu 14.04.1', 'Ubuntu 14.04.1'), ('Ubuntu 14.04.2', 'Ubuntu 14.04.2'), ('Ubuntu 14.04.3', 'Ubuntu 14.04.3'), ('Ubuntu 14.04.10', 'Ubuntu 14.04.10'), ('RHEL 7.0', 'RHEL 7.0'), ('CentOS 6.6', 'CentOS 6.6'), ('CentOS 6.7', 'CentOS 6.7'), ('CentOS 7.0', 'CentOS 7.0'), ('Fedora 22', 'Fedora 22'), ('PowerKVM 2.1.1', 'PowerKVM 2.1.1')])),
                ('kernel_version', models.CharField(default='3.16.0', max_length=64, verbose_name='Kernel Version', choices=[('2.6.32', '2.6.32'), ('3.10.0', '3.10.0'), ('3.10.53', '3.10.53'), ('3.10.89', '3.10.89'), ('3.13.0', '3.13.0'), ('3.16.0', '3.16.0'), ('3.19.0', '3.19.0'), ('4.0.4', '4.0.4'), ('4.1.0', '4.1.0')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kernel_version', models.CharField(default='3.16.0', max_length=64, verbose_name='Kernel Version', choices=[('2.6.32', '2.6.32'), ('3.10.0', '3.10.0'), ('3.10.53', '3.10.53'), ('3.10.89', '3.10.89'), ('3.13.0', '3.13.0'), ('3.16.0', '3.16.0'), ('3.19.0', '3.19.0'), ('4.0.4', '4.0.4'), ('4.1.0', '4.1.0')])),
                ('dependence_information', models.TextField(max_length=1024, verbose_name='Dependency Instruction', blank=True)),
                ('machine_side', models.CharField(default='client_side', max_length=32, verbose_name='Machine Role', choices=[('frontend', 'As a Frontend'), ('backend', 'As a Backend'), ('client_side', 'As a Client')])),
                ('machine_name', models.CharField(default='Habonaro', max_length=32, verbose_name='Machine Name', choices=[('Habonaro', 'Habonaro'), ('Palmetto', 'Palmetto'), ('S812L', 'S812L'), ('S822L', 'S822L'), ('X86_E5', 'X86 E5 Series')])),
                ('architecture_type', models.CharField(default='powerpc', max_length=32, verbose_name='Architecture', choices=[('x86', 'x86'), ('powerpc', 'powerpc'), ('arm64', 'arm64'), ('mips', 'mips')])),
                ('byte_order', models.CharField(default='big_endian', max_length=32, verbose_name='Litter or Big endian', choices=[('litter_endian', 'Litter Endian'), ('big_endian', 'Big Endian')])),
                ('cpu_frequency', models.FloatField(verbose_name='CPU Clock Rate (GHZ)')),
