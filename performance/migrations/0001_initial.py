    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cpu_type', models.CharField(max_length=32, choices=[('CPU 1.0', 'CPU 1.0'), ('CPU 1.1', 'CPU 1.1')], verbose_name='CPU Type', default='CPU 1.0')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False, auto_created=True, verbose_name='ID')),
                ('machine_side', models.CharField(max_length=32, choices=[('server_side', 'As a Server'), ('client_side', 'As a Client')], verbose_name='Server/Client', default='server_side')),
                ('machine_name', models.CharField(max_length=32, choices=[('Habonaro', 'Habonaro'), ('Palmetto', 'Palmetto'), ('S812L', 'S812L'), ('S822L', 'S822L'), ('X86_E5', 'X86 E5 Series')], verbose_name='Machine Name', default='Habonaro')),
                ('architecture_type', models.CharField(max_length=32, choices=[('x86', 'x86'), ('powerpc', 'powerpc'), ('arm64', 'arm64'), ('mips', 'mips')], verbose_name='Architecture', default='powerpc')),
                ('byte_order', models.CharField(max_length=32, choices=[('litter_endian', 'Litter Endian'), ('big_endian', 'Big Endian')], verbose_name='Litter or Big endian', default='big_endian')),
                ...
                ('os_type', models.CharField(max_length=64, choices=[('Ubuntu 14.04.1', 'Ubuntu 14.04.1'), ('Ubuntu 14.04.2', 'Ubuntu 14.04.2'), ('Ubuntu 14.04.3', 'Ubuntu 14.04.3'), ('Ubuntu 14.04.10', 'Ubuntu 14.04.10'), ('RHEL 7.0', 'RHEL 7.0'), ('CentOS 6.6', 'CentOS 6.6'), ('CentOS 6.7', 'CentOS 6.7'), ('CentOS 7.0', 'CentOS 7.0'), ('Fedora 22', 'Fedora 22'), ('PowerKVM 2.1.1', 'PowerKVM 2.1.1')], verbose_name='Operation System', default='Ubuntu 14.04.2')),
                ('kernel_version', models.CharField(max_length=64, choices=[('2.6.32', '2.6.32'), ('3.10.0', '3.10.0'), ('3.10.53', '3.10.53'), ('3.10.89', '3.10.89'), ('3.13.0', '3.13.0'), ('3.16.0', '3.16.0'), ('3.19.0', '3.19.0'), ('4.0.4', '4.0.4'), ('4.1.0', '4.1.0')], verbose_name='Kernel Version', default='3.16.0')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kernel_version', models.CharField(max_length=64, choices=[('2.6.32', '2.6.32'), ('3.10.0', '3.10.0'), ('3.10.53', '3.10.53'), ('3.10.89', '3.10.89'), ('3.13.0', '3.13.0'), ('3.16.0', '3.16.0'), ('3.19.0', '3.19.0'), ('4.0.4', '4.0.4'), ('4.1.0', '4.1.0')], verbose_name='Kernel Version', default='3.16.0')),
                ('dependence_information', models.TextField(max_length=1024, verbose_name='Dependency Instruction', blank=True)),
                ('machine_side', models.CharField(max_length=32, choices=[('frontend', 'As a Frontend'), ('backend', 'As a Backend'), ('client_side', 'As a Client')], verbose_name='Machine Role', default='client_side')),
                ('machine_name', models.CharField(max_length=32, choices=[('Habonaro', 'Habonaro'), ('Palmetto', 'Palmetto'), ('S812L', 'S812L'), ('S822L', 'S822L'), ('X86_E5', 'X86 E5 Series')], verbose_name='Machine Name', default='Habonaro')),
                ('architecture_type', models.CharField(max_length=32, choices=[('x86', 'x86'), ('powerpc', 'powerpc'), ('arm64', 'arm64'), ('mips', 'mips')], verbose_name='Architecture', default='powerpc')),
                ('byte_order', models.CharField(max_length=32, choices=[('litter_endian', 'Litter Endian'), ('big_endian', 'Big Endian')], verbose_name='Litter or Big endian', default='big_endian')),
                ('cpu_frequency', models.DecimalField(decimal_places=4, max_digits=8, verbose_name='CPU Clock Frequency (GHZ)')),
